	...
	public LoginWindow() {
		...
		buttonLogin.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String abfPasswort = "12345";
				String abfBenutzername = "Alexander";
				
				String passText = new String(txtPassword.getPassword());
								
				if(txtUsername.getText().equals(abfBenutzername) && passText.equals(abfPasswort)) {
					GUI.MainWindow.setUser(txtUsername.getText());
					MainWindow.loggedinUser = txtUsername.getText();
					MainWindow.buttonLogin.setText("Logout");
					setVisible(false);
					dispose();
				} else if((!(txtUsername.getText().equals(abfBenutzername)) && !(passText.equals(abfPasswort))) ||
						  !((txtUsername.getText().equals(abfBenutzername)) && passText.equals(abfPasswort)) ||
						  (txtUsername.getText().equals(abfBenutzername) && !(passText.equals(abfPasswort)))	
						) {
					labelError.setText("Benutzername und Passwort stimmen nicht �berein");
