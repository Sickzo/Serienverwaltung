...
public class MainWindow extends JFrame {
	...
	static JLabel labelGreeting = new JLabel("Hallo Benutzerverwaltung.Benutzer");
	...
	public MainWindow() {
		...
		panelTop.setLayout(null);
			...
			labelGreeting.setText("Hallo Benutzer");;
			...
			JButton buttonLogin = new JButton("Einloggen");
